        ...
        >
          ...
          <div className="ms-md-3 flex-grow-1 text-center text-md-start">
            ...
            <p className="card-text mb-1" id={styles.info}>
              Agent: {booking.property.agent?.name}{" "}
              {booking.property.agent?.surname},{" "}
              {booking.property.agent?.phoneNumber}
            </p>
            <div
              className={`d-flex justify-content-center justify-content-md-start ${styles.propertyList}`}
            >
  ...
  return (
    <>
      ...
      <div className="container mt-5 mb-5">
        ...
        <div
          className="d-flex justify-content-start mb-5 pb-3"
        ...
        >
          <button
            ...
            style={{
              color:
                activeTab === "Upcoming" ? "var(--primary-color)" : "inherit",
              fontWeight: "600",
            }}
          >
            Upcoming
          ...
          <button
            ...
            style={{
              color:
                activeTab === "Completed" ? "var(--primary-color)" : "inherit",
              fontWeight: "600",
            }}
          >
            Completed
          ...
          <button
            ...
            style={{
              color:
                activeTab === "Canceled" ? "var(--primary-color)" : "inherit",
              fontWeight: "600",
            }}
          >
            Canceled
        ...
        {activeTab === "Upcoming" &&
          renderBookings(filteredBookings("Pending"))}
        {activeTab === "Completed" &&
          renderBookings(filteredBookings("Finished"))}
        {activeTab === "Canceled" &&
          renderBookings(filteredBookings("Canceled"))}
      </div>
    </>
  );
};
