            ...
            <div className="col-lg-8">
                <div className="row">
                    <div className="col-lg-6">
                       ...
                       <h5 className="py-2">{property?.address}, {property?.city}</h5>
                    </div>
                    <div className="d-flex justify-content-start py-2">
  
                      <div className="d-flex align-items-center pe-3 border-end">
                        <span className={styles.propertyText}>{property?.bathroom} baths</span>
                      </div>
                        
                      <div className="d-flex align-items-center px-3 border-end">
                      <span className={styles.propertyText}>{property?.bedroom} beds</span>
                      </div>
  
                      <div className="d-flex align-items-center ps-3 ">
                      <span className={styles.propertyText}>{property?.area} area m²</span>
                      </div>
                    </div>
