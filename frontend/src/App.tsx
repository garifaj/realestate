...
const CreateProperty = lazy(() => import('./pages/property/admin/CreateProperty'));
const AllProperties = lazy(() => import('./pages/property/home/AllProperties'));
const PropertyDetails = lazy(() => import('./pages/property/home/PropertyDetails'));
...
const AdminDashboard = lazy(() => import("./components/layout/admin/AdminDashboard"));
const UsersTable = lazy(() => import("./pages/user/admin/UsersTable"));
const AgentsTable = lazy(() => import("./pages/agent/admin/AgentsTable"));
const PropertiesTable = lazy(() => import("./pages/property/admin/PropertiesTable"));
...
const DashboardLayout = lazy (() => import('./components/layout/admin/DashboardLayout'));
