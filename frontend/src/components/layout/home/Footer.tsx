                    ...
                    <div className="col-md d-flex justify-content-center py-4">
                        <nav className={styles.nav}>
                            <ul className='list-unstyled d-flex gap-3 flex-column'>
                                ...
                                <li><a className="text-decoration-none" href="/#">Properties</a></li>
                                <li><a className="text-decoration-none" href="/#">Agents</a></li>
