...
const MessagesReportSection = () => {
  ...
  const unreadMessages = messages.filter((message:ContactUs) => message.isAnswered === false).length;
  const readMessages = messages.filter((message:ContactUs) => message.isAnswered === true).length;
                  ...
                  <div className="d-flex align-items-center">
                    <span
                      style={{
                        ...
                        width: "12px",
                        height: "12px",
                        backgroundColor: ["#FF6F61", "#FFD700", "#4CAF50"][index],
                        borderRadius: "50%",
                        marginRight: "8px",
                      }}
                    ></span>
