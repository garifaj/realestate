        ...
        <div className="row">
            ...
            <div className="col-lg-3 col-md-6 col-sm-6 py-2">
                <div className="card rounded-4 border-0  py-1" id={styles.cardShadow}>
                    ...
                    <div className="d-flex flex-wrap align-items-center">
                        <div className="col-3">
                        <svg fill="#000000" version="1.1" id="XMLID_276_" xmlns="http://www.w3.org/2000/svg" xmlnsXlink={"http://www.w3.org/1999/xlink"} viewBox="-9.6 -9.6 43.20 43.20" xmlSpace="preserve" width="64px" height="64px"><g id="SVGRepo_bgCarrier" strokeWidth="0" transform="translate(0,0), scale(1)"><rect x="-9.6" y="-9.6" width="43.20" height="43.20" rx="8.64" fill="#7ed0ec" strokeWidth={0}></rect></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round" stroke="#CCCCCC" strokeWidth="0.048"></g><g id="SVGRepo_iconCarrier"> <g id="contact-us"> <g> <path d="M4,24v-5H0V0h23v19h-9.3L4,24z M2,17h4v3.7l7.3-3.7H21V2H2V17z"></path> </g> <g> <rect x="5" y="8" width="3" height="3"></rect> </g> <g> <rect x="10" y="8" width="3" height="3"></rect> </g> <g> <rect x="15" y="8" width="3" height="3"></rect> </g> </g> </g></svg>
                        </div>
                        <div className="col-8 ms-3">
                            <span>Messages</span>
            ...
            <div className="col-lg-3 col-md-6 col-sm-6 py-2">
                <div className="card rounded-4 border-0 py-1" id={styles.cardShadow}>
                    ...
                    <div className="d-flex flex-wrap align-items-center">
                        <div className="col-3">
                        <svg width="64px" height="64px" viewBox="-4.8 -4.8 33.60 33.60" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" strokeWidth="0"><rect x="-4.8" y="-4.8" width="33.60" height="33.60" rx="6.72" fill="#3874ff" strokeWidth="0"></rect></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M13 20V18C13 15.2386 10.7614 13 8 13C5.23858 13 3 15.2386 3 18V20H13ZM13 20H21V19C21 16.0545 18.7614 14 16 14C14.5867 14 13.3103 14.6255 12.4009 15.6311M11 7C11 8.65685 9.65685 10 8 10C6.34315 10 5 8.65685 5 7C5 5.34315 6.34315 4 8 4C9.65685 4 11 5.34315 11 7ZM18 9C18 10.1046 17.1046 11 16 11C14.8954 11 14 10.1046 14 9C14 7.89543 14.8954 7 16 7C17.1046 7 18 7.89543 18 9Z" stroke="#000000" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path> </g></svg>
                        </div>
                        <div className="col-8 ms-3">
                            <span>Users</span>
                            <h5>{userCount}</h5>
