    ...
    <>
     <div className="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                ...
                <ul className="nav nav-pills flex-column gap-2 mb-sm-auto mb-0 align-items-start align-items-sm-start w-100" id="menu">
                    <li className="w-100">
                        <NavLink to="/admin/dashboard" className="d-flex align-items-center gap-3 nav-link " id={styles.navLink} aria-current="page">
                    ...
                    <li className="w-100">
                        <NavLink to="/admin/properties" className="d-flex align-items-center gap-3 nav-link " id={styles.navLink} aria-current="page">
                    ...
                    <li className="w-100">
                        <NavLink to="/admin/bookings" className="d-flex align-items-center gap-3 nav-link " id={styles.navLink} aria-current="page">
                    ...
                    <li className="w-100">
                        <NavLink to="/admin/users" className="d-flex align-items-center gap-3 nav-link " id={styles.navLink} aria-current="page">
                    ...
                    <li className="w-100">
                        <NavLink to="/admin/agents" className="d-flex align-items-center gap-3 nav-link" id={styles.navLink} aria-current="page">
                    ...
                    <li className="w-100 border-bottom pb-3">
                        <NavLink to="/admin/contactus" className="d-flex align-items-center gap-3 nav-link " id={styles.navLink} aria-current="page">
                ...
                <button onClick={handleLogout} className="d-flex align-items-center gap-3 nav-link py-4" id={styles.navLink}>
